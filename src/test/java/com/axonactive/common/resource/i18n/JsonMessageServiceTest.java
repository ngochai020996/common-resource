...
public class JsonMessageServiceTest {
	...
	private static final String JSON_MESSAGE_BUNDLE = "com.axonactive.common.resource.i18n.message_json";
    
    private JsonMessageService messageResourceService;
    
    
    @Before
    public void init() {
        this.messageResourceService = new JsonMessageService(JSON_MESSAGE_BUNDLE);
    }
